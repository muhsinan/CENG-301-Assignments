...
public:
    ...
    */
    ...
    void findConnectedComponents(bool* visited, int* componentIds, int componentId, int node);
    int calculateSumOfDistances(int componentId, int node, int* componentIds);
